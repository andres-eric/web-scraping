...
google_api_key = "AIzaSyAn6INg0ApeeNHnCV3dn8hEO1Zip6mpaLI" # <-- ¡Pega tu clave real aquí!
os.environ["GOOGLE_API_KEY"] = google_api_key
    # --- FIN Configuración directa ---



if not google_api_key: # si la api key esta vacia devuelve mensaje de error
...
try:
        Hyperbrowser_api_key = "hb_ef22f5f61457e7978e4393516f05"
...
page_content = crawl_tool.invoke({
    ...
    "render": True,  # Sugerir renderizado completo
    "wait_time": 20   # Sugerir esperar 5 segundos
